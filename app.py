...
st.set_page_config(
    page_title="Digital Footprint Investigator",
    page_icon="🕵️‍♂️",
    layout="wide",
...
def main():
    ...
    if not os.getenv("ANTHROPIC_API_KEY") and not os.getenv("OPENAI_API_KEY"):
        st.warning("⚠️ No LLM API key found in .env file. Please configuring your API keys.")
    ...
    def start_investigation():
        ...
        st.session_state.report_content = None # Clear previous results
        st.session_state.latest_report_file = None
    ...
    # Main Content
    st.title("🕵️‍♂️ Digital Footprint Investigator")
    st.markdown("""
    > **⚠️ EDUCATIONAL USE ONLY**: This tool is designed for educational purposes, security research, and legitimate OSINT investigations. 
    ...
    with col1:
        st.text_input("Target Identifier", placeholder="Enter Name, Email, Username, or Phone Number...", key="target_input")
    ...
    with col2:
        ...
        if st.session_state.processing:
             ...
             st.button("🚀 Start Investigation", type="primary", use_container_width=True, on_click=start_investigation, key="start_btn")
